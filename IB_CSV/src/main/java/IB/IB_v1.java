...
@Layer1StrategyName("IB_v1")
@Layer1ApiVersion(Layer1ApiVersionValue.VERSION2)
public class IB_v1 implements CustomModule, IntervalListener, HistoricalDataListener, TimeListener, CustomSettingsPanelProvider {
		...
		BufferedReader reader = null;
		  ...
		  try {			  
			...
			for(PlotVals p: plotV) {		
				//Log.info("ReadCSV- " + symStr +  " = " + p.getSymbol() + " PLevel " +  p.getPLevel() + " Note " + p.getNote() + " StopTime " + p.getStopTime() + " ReStartTime " + p.getReStartTime());
...
*/
		...
		//Log.info("StartT- " + StartT.toString());
		 			  						
		//Log.info("getTiimes- " + " |StartT " + StartT.toString());				
		return TimeS;		
	 }		
    
	 
     public void compiledata(String PName, String Plevel, String Starttime, String PColor) {		  	
		...
		if (!Plevel.contains("999999")) {
	 	...
	 	//Log.info("compileData- "  + symStr + " Time is "  + TimeNow.toString() + " |plotStr " + plotStr + " |Price " + Price.toString() + " |TimeS " + TimeS.toString() + " |TimeE " + TimeE.toString());		
